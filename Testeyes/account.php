...
<title>Project Worlds || TEST YOUR EYES</title>
...
<div class="row">
<div class="col-lg-6">
<span class="logo">Test Your Eyes</span></div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="E:\Testeyes\image\HH.jpg" width=100 height=100 alt="Ritesh Datar" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a href="http://yugeshverma.blogspot.in" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">Ritesh Datar</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+91 9922633108</h4>
		<h4 style="font-family:'typo' ">riteshdatar23@gmail.com</h4>
		<h4 style="font-family:'typo' ">Dr.Ambedkar Institute Of Management And Research,Nagpur</h4></div></div>
		</p>
      </div>
